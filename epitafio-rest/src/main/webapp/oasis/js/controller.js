...
//});
	...
	//Set Map
function initialize() {
   var longitud=$rootScope.HTMLMain.cuerpo.longitud;
   var latitud=$rootScope.HTMLMain.cuerpo.latitud;
//    alert('Longitud: ' + $rootScope.HTMLMain.cuerpo.longitud);
//    alert('latitud: ' + $rootScope.HTMLMain.cuerpo.latitud);
